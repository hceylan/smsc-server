...
public interface Authority {
     ...
     * @return Returns a populated AuthorizationRequest as long as If {@link #canAuthorize(AuthorizationRequest)}
     *         returns true for the AuthorizationRequest, otherwise returns null.
     *         {@link #canAuthorize(AuthorizationRequest)} should always be checked before calling this method.
     */
