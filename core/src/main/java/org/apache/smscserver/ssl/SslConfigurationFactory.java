...
public class SslConfigurationFactory {
    ...
    private KeyStore loadStore(File storeFile, String storeType,
        ...
        try {
            if(storeFile.exists()) {
                ...
                if(fin == null) {
                    throw new SmscServerConfigurationException("Key store could not be loaded from " + storeFile.getPath());
                }
            }
    ...
    public SslConfiguration createSslConfiguration() {
        ...
        try {
            ...
            throw new SmscServerConfigurationException("DefaultSsl.configure()",
                    ex);
        }
    }
