 ...
 * 
 * This class is only used on Java 1.4 systems, on Java 1.5 and newer the @see {@link ExtendedAliasKeyManager} is used
 * instead
 * 
...
public final class AliasKeyManager implements X509KeyManager {
     ...
     * @param socket
     *            The socket to be used for this connection. This parameter can be null, in which case this method will
