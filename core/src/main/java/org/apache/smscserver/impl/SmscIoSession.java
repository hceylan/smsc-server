 ...
 * 
 */
public class SmscIoSession implements IoSession {
    ...
    private static final String ATTRIBUTE_LANGUAGE = SmscIoSession.ATTRIBUTE_PREFIX + "language";
    private static final String ATTRIBUTE_LOGIN_TIME = SmscIoSession.ATTRIBUTE_PREFIX + "login-time";
    private static final String ATTRIBUTE_FAILED_LOGINS = SmscIoSession.ATTRIBUTE_PREFIX + "failed-logins";
    ...
    public SmscIoSession(IoSession wrappedSession, SmscServerContext context) {
    ...
    public int getFailedLogins() {
        return (Integer) this.getAttribute(SmscIoSession.ATTRIBUTE_FAILED_LOGINS, 0);
    }
    ...
    public Date getLastAccessTime() {
        return (Date) this.getAttribute(SmscIoSession.ATTRIBUTE_LAST_ACCESS_TIME);
    }
    ...
    public Listener getListener() {
        return (Listener) this.getAttribute(SmscIoSession.ATTRIBUTE_LISTENER);
    }
    ...
    public Date getLoginTime() {
        return (Date) this.getAttribute(SmscIoSession.ATTRIBUTE_LOGIN_TIME);
    }

    public int getMaxIdleTime() {
        return (Integer) this.getAttribute(SmscIoSession.ATTRIBUTE_MAX_IDLE_TIME, 0);
    }
    ...
    public SocketAddress getRemoteAddress() {
        ...
        if ((address == null) && this.containsAttribute(SmscIoSession.ATTRIBUTE_CACHED_REMOTE_ADDRESS)) {
            return (SocketAddress) this.getAttribute(SmscIoSession.ATTRIBUTE_CACHED_REMOTE_ADDRESS);
        } else {
            this.setAttribute(SmscIoSession.ATTRIBUTE_CACHED_REMOTE_ADDRESS, address);
            return address;
        }
    }
    ...
    public UUID getSessionId() {
        synchronized (this.wrappedSession) {
            if (!this.wrappedSession.containsAttribute(SmscIoSession.ATTRIBUTE_SESSION_ID)) {
                this.wrappedSession.setAttribute(SmscIoSession.ATTRIBUTE_SESSION_ID, UUID.randomUUID());
            }
            return (UUID) this.wrappedSession.getAttribute(SmscIoSession.ATTRIBUTE_SESSION_ID);
        }
    }
    ...
    public User getUser() {
        return (User) this.getAttribute(SmscIoSession.ATTRIBUTE_USER);
    }
    ...
    public synchronized void increaseFailedLogins() {
        int failedLogins = (Integer) this.getAttribute(SmscIoSession.ATTRIBUTE_FAILED_LOGINS, 0);
        failedLogins++;
        this.setAttribute(SmscIoSession.ATTRIBUTE_FAILED_LOGINS, failedLogins);
    }
    ...
    public boolean isLoggedIn() {
        return this.containsAttribute(SmscIoSession.ATTRIBUTE_USER);
    }
    ...
    public void reinitialize() {
        this.unbindUser();
        this.removeAttribute(SmscIoSession.ATTRIBUTE_USER);
        this.removeAttribute(SmscIoSession.ATTRIBUTE_LOGIN_TIME);
    }
    ...
    public void setLanguage(String language) {
        this.setAttribute(SmscIoSession.ATTRIBUTE_LANGUAGE, language);

    }

    public void setListener(Listener listener) {
        this.setAttribute(SmscIoSession.ATTRIBUTE_LISTENER, listener);
    }

    public void setLogin(FileSystemView fsview) {
        this.setAttribute(SmscIoSession.ATTRIBUTE_LOGIN_TIME, new Date());
    }

    public void setMaxIdleTime(int maxIdleTime) {
        this.setAttribute(SmscIoSession.ATTRIBUTE_MAX_IDLE_TIME, maxIdleTime);
    ...
    public void setUser(User user) {
        this.setAttribute(SmscIoSession.ATTRIBUTE_USER, user);
    ...
    public void updateLastAccessTime() {
        this.setAttribute(SmscIoSession.ATTRIBUTE_LAST_ACCESS_TIME, new Date());
