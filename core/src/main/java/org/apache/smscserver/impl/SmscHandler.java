...
public interface SmscHandler {
     ...
     */
    void exceptionCaught(SmscIoSession session, Throwable cause) throws Exception;
     ...
     */
    SmscReply messageReceived(SmscIoSession session, SmscRequest request) throws Exception;
     ...
     */
    void sessionClosed(SmscIoSession session) throws Exception;
     ...
     * initialization.
     */
    void sessionCreated(SmscIoSession session) throws Exception;

    /**
     * Invoked with the related {@link IdleStatus} when a connection becomes idle.
     */
    void sessionIdle(SmscIoSession session, IdleStatus status) throws Exception;

    /**
     * Invoked when a connection has been opened. This method is invoked after {@link #sessionCreated(SmscIoSession)}.
     * The biggest difference from {@link #sessionCreated(SmscIoSession)} is that it's invoked from other thread than an
     * I/O processor thread once thread modesl is configured properly.
     */
    void sessionOpened(SmscIoSession session) throws Exception;
}
