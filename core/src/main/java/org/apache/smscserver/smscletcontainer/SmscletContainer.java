...
package org.apache.smscserver.smscletcontainer;
...
public interface SmscletContainer extends Smsclet {
    ...
    /**
     * Retrive all Smsclets registered with this container
     * 
     * @return A map of all Smsclets with their name as the key
     */
    Map<String, Smsclet> getSmsclets();
}