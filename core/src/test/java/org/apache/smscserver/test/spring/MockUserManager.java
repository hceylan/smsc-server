...
public class MockUserManager implements UserManager {
    ...
    public void delete(String username) throws SmscException {
    }

    public boolean doesExist(String username) throws SmscException {
        return false;
    }

    public String getAdminName() throws SmscException {
        return null;
    }
    ...
    public User getUserByName(String username) throws SmscException {
        return null;
    }

    public boolean isAdmin(String username) throws SmscException {
        return false;
    }
    ...
    public void setContext(SmscletContext serverContext) {
    }
